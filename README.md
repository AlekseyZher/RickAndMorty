...
[Перейти к просмотру приложения](https://alekseyzher.github.io/RickAndMorty/).

Проект представляет собой приложение, которое получает и отображает персонажей, локации и эпизоды из [Rick and Morty API](https://rickandmortyapi.com/).


![Preview](./docs/large-logo.png)
...
| `npm run build` | Сборка для проекта |
